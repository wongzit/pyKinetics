...
Label(proInfoFrame, text = 'Zhe Wang: GUI & basic function\nTakuma Miyamura: Line fitting\n\n').pack()
...
quitButton = Button(root, image = setIcon, padx = 20, pady = 7, command = sysSetting).grid(row = 2, column = 2)
